  ...
  render() {
    return (
      <Deck transition={["none"]} theme={theme} progress="bar">
        <Slide bgImage={images.bg} bgDarken={0.5}>
        ...
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <Text textColor="tertiary" style={{fontSize: '5rem', margin: "0px 0px 30px 0px", textTransform: 'uppercase'}}>
            <StrangeText>IS THAT HTML IN MY JS?</StrangeText>
          </Text>
          <CodePane lang="javascript" textSize={36} source={`render() {
  return (
    <div>{this.props.whatever}</div>
        ...
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <Text textColor="tertiary" style={{fontSize: '5rem', textTransform: 'uppercase'}}>
            <StrangeText>No, that's JSX and these are components</StrangeText>
          </Text>
        </Slide>
        <Slide bgImage={images.bg} bgDarken={0.5}>
        ...
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <Text textColor="tertiary" style={{fontSize: '3rem', margin: "0px 0px 30px", textTransform: 'uppercase'}}>
            <StrangeText>Productivity like whoa</StrangeText>
          </Text>
        ...
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <Text textColor="tertiary" style={{fontSize: '7rem', textTransform: 'uppercase'}}>
            <StrangeText>gl-react (v3)</StrangeText>
          </Text>
        </Slide>
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <List>
            <StyledListItem>OpenGL/WebGL bindings for React</StyledListItem>
            <StyledListItem>React, React Native & Headless</StyledListItem>
            <StyledListItem>Also uses context</StyledListItem>
            <StyledListItem>Renders to a drawing context</StyledListItem>
          </List>
        </Slide>
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <Heading size={1} caps lineHeight={1} textColor="secondary">
...
function inject() {
  ReactInjection.NativeComponent.injectGenericComponentClass(
    MyCustomComponentClass
        ...
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <List>
            <StyledListItem>render() function</StyledListItem>
            <StyledListItem>Batching strategy</StyledListItem>
            <StyledListItem>Transaction</StyledListItem>
            <StyledListItem>mount</StyledListItem>
          </List>
        </Slide>
        <Slide bgImage={images.bg} bgDarken={0.5}>
          <Text textColor="tertiary" style={{fontSize: '5rem', textTransform: 'uppercase'}}>
